...
#Photon Pt
phpthist_0 = g0.Get("TestHepMCEvt/Photon_Pt")
phpthist_1 = g1.Get("TestHepMCEvt/Photon_Pt")
phpthist_2 = g3.Get("TestHepMCEvt/Photon_Pt")
phpthist_3 = g3.Get("TestHepMCEvt/Photon_Pt")
phpthist_4 = g4.Get("TestHepMCEvt/Photon_Pt")
phpthist_5 = g5.Get("TestHepMCEvt/Photon_Pt")
phpthist_6 = g6.Get("TestHepMCEvt/Photon_Pt")
...
# Label Axis
hist_12.GetXaxis().SetTitle("T^{#gamma}[GEN](ns)")
hist_12.GetYaxis().SetTitle("Events")
...
#Choose LineWidth
phpthist_0.SetLineWidth(4)
phpthist_1.SetLineWidth(4)
phpthist_2.SetLineWidth(4)
phpthist_3.SetLineWidth(4)
phpthist_4.SetLineWidth(4)
phpthist_5.SetLineWidth(4)
phpthist_6.SetLineWidth(4)
#Choose Marker Style!
...
# Label Axis
phpthist_6.GetXaxis().SetTitle("Pt_{#gamma}(GeV)")
phpthist_6.GetYaxis().SetTitle("Events")
...
hist_12.SetTitle("Photon Arrival Time[ns]")
hist_12.Draw()
hist_11.Draw("sames")
hist_10.Draw("sames")
hist_9.Draw("sames")
...
hist_7.Draw("sames")
hist_6.Draw("sames")
hist_12.GetXaxis().SetRangeUser(0.0, 200.0)
#hist_12.GetYaxis().SetRangeUser(0.0, 10000.0)
#Add Legend
leg2 = TLegend( 0.60, 0.70, 0.90, 0.90)
leg2.SetBorderSize(1)
leg2.SetFillColor(0)
leg2.AddEntry(hist_12,"#Lambda=180 TeV, c#tau=6000mm","l")
leg2.AddEntry(hist_11,"#Lambda=180 TeV, c#tau=4000mm","l")
leg2.AddEntry(hist_10,"#Lambda=180 TeV, c#tau=3000mm","l")
leg2.AddEntry(hist_9,"#Lambda=180 TeV, c#tau=2000mm","l")
leg2.AddEntry(hist_8,"#Lambda=180 TeV, c#tau=1000mm","l")
leg2.AddEntry(hist_7,"#Lambda=180 TeV, c#tau=500mm","l")
leg2.AddEntry(hist_6,"#Lambda=180 TeV, c#tau=250mm","l")
...
leg3.AddEntry(pthist_4,"#Lambda=180 TeV, c#tau=3000mm","l")
...
phpthist_0.Draw("sames")
phpthist_6.GetXaxis().SetRangeUser(0.0, 2000.0)
#Add Legend
leg4 = TLegend( 0.60, 0.70, 0.90, 0.90)
leg4.SetBorderSize(1)
leg4.SetFillColor(0)
leg4.AddEntry(phpthist_6,"#Lambda=180 TeV, c#tau=6000mm","l")
leg4.AddEntry(phpthist_5,"#Lambda=180 TeV, c#tau=4000mm","l")
leg4.AddEntry(phpthist_4,"#Lambda=180 TeV, c#tau=3000mm","l")
leg4.AddEntry(phpthist_3,"#Lambda=180 TeV, c#tau=2000mm","l")
leg4.AddEntry(phpthist_2,"#Lambda=180 TeV, c#tau=1000mm","l")
leg4.AddEntry(phpthist_1,"#Lambda=180 TeV, c#tau=500mm","l")
leg4.AddEntry(phpthist_0,"#Lambda=180 TeV, c#tau=250mm","l")
